...
import 'package:tidal_wave/data/repositories/tw_user_repository_implement.dart';
...
class _HomePageScreenState extends State<HomePageScreen> {
  ...
  Future<void> validateAndGetUser(User? user) async {
    if (user?.uid != null) {
      final twur = TWUserRepositoryImplement(TypeDataBase.firestore);
  ...
  Widget build(BuildContext context) {
    ...
    if(context.read<UserCubit>().state == null){
      ...
      _drawerOptions.addAll([
        ...
        {"Lista old": () async {
          final tempList = await TWMusicRepositoryImplement(TypeDataBase.firestore).getAll();
